...
class UserProfile(AbstractUser):
    nick_name = models.CharField(max_length=50, null=False, verbose_name=u"昵称")
    gender = models.CharField(max_length=2, null=True, choices=(("M", "男"), ("F", "女")))
    mobile_phone = models.CharField(max_length=12, null=False, verbose_name=u"电话", unique=True)
...
class Staff(models.Model):
    ...
    mobile_phone = models.CharField(max_length=12, verbose_name=u"员工电话", null=False)
